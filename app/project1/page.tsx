...
const META = [
  ...
  { label: "Type",    value: "Mockup Visualisatie"     },
  { label: "Tooling", value: "Photoshop & Illustrator" },
  { label: "Medium",  value: "Digital Poster / OOH"   },
];
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0 1.5rem" : "0 3rem" }}>
        ...
        <section style={{
          ...
          <div style={{ overflow: "hidden" }}>
            ...
            >
              Brewtopia{" "}
              <em style={{ color: ACCENT }}>in de Stad.</em>
            </motion.h1>
          </div>
        </section>

        {/* ── Block 1: tekst links · foto rechts ── */}
        <section style={{
          display:             "grid",
          ...
          >
            ...
            <p style={{
              ...
              Voor dit project lag de focus op het vertalen van een productconcept naar een
              realistische omgeving. Ik heb een poster ontworpen voor mijn eigen drankenmerk,{" "}
              <strong style={{ color: FG, fontWeight: 600 }}>Brewtopia</strong>, waarbij typografie
              en kleurgebruik het unieke karakter van het blikje versterken.
            </p>
            <p style={{
              fontFamily: "'Inter', sans-serif",
              fontSize:   15,
              ...
              De poster is verwerkt in een high-quality mockup om de impact in het straatbeeld
              te visualiseren — van scherm naar buiten.
            </p>
        ...
        {/* ── Block 2: foto links · tekst rechts ── */}
        <section style={{
          display:             "grid",
          gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr",
          gap:                 isMobile ? "2rem" : "5rem",
          ...
          >
            <Image
              src="/project1-visual.png"
              alt="Brewtopia Visual"
              fill
              style={{ objectFit: "cover" }}
            />
          </motion.div>
          ...
          >
            ...
            <p style={{
              ...
              De typografische keuzes zijn bewust minimalistisch gehouden — het product spreekt
              voor zichzelf. Het kleurgebruik sluit aan bij de merkidentiteit van Brewtopia:
              helder, fris en herkenbaar.
            </p>
            <p style={{
              fontFamily: "'Inter', sans-serif",
              fontSize:   15,
              ...
              Het eindresultaat is een samenspel van product, typografie en omgeving dat de
              kijker meteen trekt.
            </p>
        ...
        <section style={{
          ...
          >
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontWeight: 700, fontStyle: "italic", color: FG }}>CineCity</div>
            </div>
